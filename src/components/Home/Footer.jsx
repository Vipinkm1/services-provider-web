    ...
    <div className='footer-flex'>
      <div className='footer-container-1'>
        ...
        <div className='some-content'>
          <a href="#" className="brand">Gulf<span style={{ color: 'green' }}>Ulinkit</span></a>
      ...
      <div className='footer-container-2'>
        ...
        <div className='some-content'>
          <div className='footer-services'>Home</div>
          <div className='footer-services'>About</div>
          <div className='footer-services'>Services</div>
          <div className='footer-services'>Portfolio</div>
          <div className='footer-services'>Blog</div>
        ...
        <div className='footer-content-flex'>
          <div className='some-content'>
            ...
            <div className='footer-contact'>
              ...
              <p className='para2'>Phone: <span>+91 8750518844 </span></p>
            </div>
            <div className='footer-contact'>
              <GrLocation className='icons-contact' />
              <p className='para2'>Address: <span>Uttam Nagar New Delhi</span></p>
            </div>
            <div className='footer-contact'>
          ...
          <div className='some-content'>
            ...
            <div className='footer-contact'>
              <img src={Whatsapp} className='icons-contact  whatsapp-icon' />
